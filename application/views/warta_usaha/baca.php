<div class="container">
    <div class="row">
        ...
        <div class="col-xs-9">
            <div class="content">
                <h3><?php echo $warta_usaha['judul']; ?></h3>
                <div class="line"></div>
                <div><?php echo print_date($warta_usaha['tanggal_input'], array('format'=>'d F Y H:i')); ?></div>
                <div class="mt20"><?php echo $warta_usaha['konten']; ?></div>
