<div class="row show-grids">
    ...
    <div class="col-xs-9">
        <h3 class="mp00"><?php echo (@$mode == 'edit' ? 'Edit Berita Lelayu' : 'Tambah Berita Lelayu'); ?></h3>
        <div class="line"></div>
        
        <form method="post" action="<?php echo admin_url('berita/lelayu/simpan'); ?>" class="form-horizontal" role="form">
