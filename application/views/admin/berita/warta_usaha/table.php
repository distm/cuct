<div class="row show-grids">
    ...
    <div class="col-xs-9">
        ...
        <?php if(is_array($warta_usaha) && count($warta_usaha)): ?>
        
            <?php foreach($warta_usaha as $row): ?>
                <?php
                ...
                <div class="panel panel-default a-panel <?php echo (md5($row['judul']) == $flashid ? 'panel-info' : ''); ?>" id="warta_usaha-<?php echo $row['id']; ?>">
