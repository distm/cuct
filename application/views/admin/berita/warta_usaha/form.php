<div class="row show-grids">
    ...
    <div class="col-xs-9">
        <h3 class="mp00"><?php echo (@$mode == 'edit' ? 'Edit Warta Usaha' : 'Tambah Warta Usaha'); ?></h3>
        <div class="line"></div>
        
        <form method="post" action="<?php echo admin_url('berita/warta-usaha/simpan'); ?>" class="form-horizontal" role="form">
