<div class="row show-grids">
    ...
    <div class="col-xs-9">
        <h3 class="mp00"><?php echo (@$mode == 'edit' ? 'Edit Kabar' : 'Tambah Kabar'); ?></h3>
        <div class="line"></div>
        
        <form method="post" action="<?php echo admin_url('berita/kabar/simpan'); ?>" class="form-horizontal" role="form">
