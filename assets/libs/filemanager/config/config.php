...
$upload_dir = '/share/fm/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../share/fm/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../share/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
